...
//! `srs_model::PropertyPipeline`; positioned well logs are extracted from the
//! petekio wells here (the "positioned logs" wrapper).

use crate::facade::model::Model;
use crate::facade::project::BoreWell;
use crate::facade::spec::TrendSpec;
...
/// stack is all-[`srs_model::HorizonSource::Mapped`]. Every consumer
...
pub struct StaticGrid {
    ...
    ties: Vec<crate::facade::framework::TieResidual>,
...
impl StaticGrid {
    ...
    pub fn ties(&self) -> &[crate::facade::framework::TieResidual] {
        &self.ties
    }
...
mod tests {
    ...
    use srs_model::ConstantPriors;
    use srs_wireframe::{Boundary, GriddedDepth, Hardness, Horizon, HorizonRole};
