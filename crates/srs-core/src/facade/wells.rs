...
fn build_log_well(
    ...
    ties: &[crate::facade::WellTieResidual],
) -> Option<LogWell> {
...
fn nearest_column(
    columns: &[crate::view::SectionColumn],
    x: f64,
    y: f64,
) -> Option<&crate::view::SectionColumn> {
...
fn framework_picks(
    model: &Model,
    section: &crate::view::IntersectionBundle,
    col: &crate::view::SectionColumn,
) -> (Vec<Top>, Vec<Zone>) {
