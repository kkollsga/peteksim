...
//! srs-data's adapter/wireframe, then apply the lifted [`peteksim::distribution_of`]
...
use peteksim::{distribution_of, ConstantPriors, Fluid, RefiningModel, WireframeSeed};
use petekstatic::data::logs::petro_samples;
use petekstatic::data::petekio::{Distribution, GeoData, Unit};
use petekstatic::data::wireframe::assemble_wireframe;
